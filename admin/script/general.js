...
function sortBy(sort_by){
	...
	if (document.getElementById("category_id")!=null){
		...
		location.href = url+"?page=1&query_per_page="+query_per_page+"&sort_by="+sort_by+"&search="+search+"&category_id="+category_id;
	}
	else if (document.getElementById("user_id")!=null){
		
		if (document.getElementById("user_id").value!=""){
		var user_id = document.getElementById("user_id").value;
		location.href = url+"?page=1&query_per_page="+query_per_page+"&sort_by="+sort_by+"&search="+search+"&user_id="+user_id;
		}	
		else{
...
function goToPage(page){
	...
	var query_per_page = document.getElementById("query_per_page").value;
	var search = document.getElementById("search").value;
	location.href = url+"?page="+page+"&query_per_page="+query_per_page+"&sort_by="+sort_by+"&search="+search;
	}
}
...
function searchQuery(s){
	if(event.keyCode == 13){
		...
		if (s=="submit_date"){
			var date_start = document.getElementById("date_start_search").value;
			var date_end = document.getElementById("date_end_search").value;
			var search = s+" BETWEEN '"+date_start+"' AND '"+date_end+"'";
			location.href=url+"?page=1&query_per_page="+query_per_page+"&sort_by="+sort_by+"&search="+search+"&date_start="+date_start+"&date_end="+date_end;
		}
		else if (s=="last_updated_date"){
			var date_start = '20'+document.getElementById("date_start_search").value.replace('/','-');
			var date_end = '20'+document.getElementById("date_end_search").value.replace('/','-');
			var search = s+" BETWEEN '"+date_start+"' AND '"+date_end+"'";
			var date_start = document.getElementById("date_start_search").value;
			var date_end = document.getElementById("date_end_search").value;
			location.href=url+"?page=1&query_per_page="+query_per_page+"&sort_by="+sort_by+"&search="+search+"&date_start="+date_start+"&date_end="+date_end;
			...
			var search = s+" LIKE '%25"+value+"' OR "+s+" LIKE '%25"+value+"%25' OR "+s+" LIKE '%25"+value+"%25'";
			location.href=url+"?page=1&query_per_page="+query_per_page+"&sort_by="+sort_by+"&search="+search+"&"+s+"="+value;
		}
...
function searchStatus(value){
	...
	location.href=url+"?page=1&query_per_page="+query_per_page+"&sort_by="+sort_by+"&search="+search+"&order_status="+value;
}
