                ...
                <div class="contact-content">
                    <form action="" method="POST">
                        ...
                        <ul class="field-set" style="list-style-type:none">
                            ...
                            <li class="contact-words">For any inquiries, please fill in the form below and we'll reply you as soon as possible, or you can directly contact through <a href="mailto:info@islandcreamery.co.id">info@islandcreamery.co.id</a>. Thank you.</li>
                            ...
                            <div class="clearfix" style="margin-top:10px">
                                ...
                                <p>Thank you! We will reply to your message soon.</p>
                            </div>
